package com.dropbox.dropboxchooser;
 ...
 * 
 * <p>
 * The result will be received in the onActivityResult callback of the Activity or Fragment supplied to {@link com.dropbox.dropboxchooser.DbxChooser#launch}.
 * </p>
 * 
 */
public class DbxChooser {
    ...
    public static class Result {
         ...
         * If the request code doesn't match the one provided to {@link com.dropbox.dropboxchooser.DbxChooser#launch(android.app.Activity, int)} or if the result code
         * was anything but {@link android.app.Activity#RESULT_OK}, this class will be unable to extract useful values.
         */
